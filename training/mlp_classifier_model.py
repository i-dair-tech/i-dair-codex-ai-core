...
def mlp_classifier(user_id,session,model_id,dataset_id,x_train,y_train,x_test,y_test,n_iter,optimizer="BayesianOptimization",param_space=None,task="classification"):
    global id_model 
    global id_dataset
    global iterations
    global session_id
    ...
    hidden_layer_sizes_list=list(param_space["hidden_layer_sizes"])
    hidden_layer_sizes = Categorical(categories=(hidden_layer_sizes_list), name='hidden_layer_sizes')
    param_space["hidden_layer_sizes"]=hidden_layer_sizes
    ...
    with mlflow.start_run(experiment_id=experiment_id) as run:
        ...
        try:
            ...
            param_space["hidden_layer_sizes"]=hidden_layer_sizes_list
            ...
            #signature = infer_signature(inputs,results)
            registered_model_name="Multilayer_perceptron_model_"+str(timestamp)
            # Log the model
            #mlflow.sklearn.log_model(search.best_estimator_, 'model',registered_model_name=registered_model_name,signature=signature)
