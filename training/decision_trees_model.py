...
def decision_trees(user_id,session,model_id, dataset_id, x_train, y_train, x_test, y_test, n_iter, optimizer="BayesianOptimization",param_space=None,task="classification"):
    global id_model 
    global id_dataset
    global iterations
    global session_id
    ...
    with mlflow.start_run(experiment_id=experiment_id) as run:
        ...
        try:
            ...
            # Log the model
            registered_model_name="decision_trees_Regression_model_"+str(timestamp)
